/**
 * CollegeDelhi Design System Tokens
...
export const tokens = {
  colors: {
    // â”€â”€ Core brand — matches globals.css @theme CSS variables â”€â”€
    primary:   "#0A1628",   // CollegeDelhi Navy — header, footer, dark CTAs (CSS: --color-primary)
