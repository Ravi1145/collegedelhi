      ...
      <section className="bg-gradient-to-br from-blue-700 to-blue-900 text-white py-14 px-4">
        <div className="max-w-5xl mx-auto">
          <nav className="text-sm text-blue-200 mb-4 flex gap-1 flex-wrap">
            ...
            <span>/</span>
            <Link href="/colleges-in-delhi" className="hover:text-white">colleges in Delhi</Link>
            <span>/</span>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { label: "Best Placements DELHI", href: "/colleges-in-delhi/top-placement-colleges-DELHI" },
