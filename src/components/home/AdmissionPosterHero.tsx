...
const TOP_COLLEGES = [
  { name: "DTU", tag: "DELHI TECHNOLOGICAL UNIVERSITY" },
  { name: "NSUT", tag: "NETAJI SUBHAS UNIVERSITY OF TECHNOLOGY" },
  { name: "IGDTUW", tag: "INDIRA GANDHI DELHI TECHNICAL UNIVERSITY" },
  { name: "IP UNIVERSITY", tag: "GURU GOBIND SINGH INDRAPRASTHA UNIVERSITY" },
  { name: "JAMIA", tag: "JAMIA MILLIA ISLAMIA" },
]
      ...
      <div className="bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] text-white py-8 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="bg-red-600 rounded-full px-6 py-3 text-center">
              <p className="text-xs font-bold text-white">DELHI'S MOST TRUSTED</p>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-block bg-[#0A1628] text-white px-8 py-2 rounded-full mb-4 font-bold text-sm">
            â­ TOP COLLEGES. BRIGHT FUTURES.
          </div>
          <h2 className="text-5xl md:text-6xl font-black mb-4">
            <span className="text-[#0A1628]">ADMISSION</span>
            <br />
            <span className="text-red-600">OPEN 2026</span>
          </h2>
          <p className="text-gray-600 text-xl font-bold">ALL IN DELHI</p>
        </div>
        ...
        {/* Top Colleges */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-[#0A1628] mb-6 text-center">TOP colleges in Delhi</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {TOP_COLLEGES.map((college) => (
              <div key={college.name} className="bg-white border-2 border-gray-200 rounded-2xl p-4 text-center hover:border-red-600 transition-colors">
                <div className="text-3xl font-black text-red-600 mb-2">{college.name}</div>
        ...
        <div className="bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] text-white rounded-3xl p-8 mb-12 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-6xl font-black text-red-600 mb-2">₹50,000</p>
            <p className="text-lg font-bold">ON MERIT BASIS</p>
          </div>
          <div className="relative">
            <div className="bg-red-600 rounded-full w-32 h-32 flex items-center justify-center mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            {ADMISSION_STEPS.map((step, idx) => (
              <div key={step.num} className="flex flex-col items-center">
                <div className="bg-red-600 text-white rounded-full w-16 h-16 flex items-center justify-center font-black text-2xl mb-3">
                  {step.icon}
                </div>
                ...
                {idx < ADMISSION_STEPS.length - 1 && (
                  <div className="hidden md:block text-3xl text-red-600 font-bold mx-4">â†’</div>
                )}
              </div>
            ))}
          </div>
