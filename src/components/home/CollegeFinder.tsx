...
// â”€â”€â”€ Quiz constants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const AREAS = [
  ...
  { label: "DELHI City",      value: "DELHI City" },
  { label: "DELHI Suburbs",   value: "DELHI Suburbs" },
...
const STEP_TITLES = [
  ...
  "Which area of DELHI do you prefer?",
  "Get your personalised college list",
]

// â”€â”€â”€ Budget â†’ fee range filter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Stream â†’ college filter â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Get matched colleges â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

function getMatches(allColleges: College[], stream: string, budget: string): College[] {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected
          ? "border-[color:var(--color-accent,#f97316)] bg-red-50 text-gray-900"
...
function CollegeCard({ college }: { college: College }) {
  return (
    <Link
      ...
      className="block border border-gray-200 rounded-xl p-4 hover:border-red-300 hover:shadow-md transition-all group"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <p className="font-bold text-gray-900 text-sm group-hover:text-red-700 transition-colors truncate">
            {college.name}
          </p>
        ...
        <span className="flex-shrink-0 text-xs font-bold bg-red-100 text-red-800 px-2 py-1 rounded-lg">
          {college.shortName}
        </span>
      </div>
      ...
      <div className="mt-2 flex items-center justify-end">
        <span className="text-xs font-semibold text-red-700 flex items-center gap-0.5 group-hover:gap-1.5 transition-all">
...
export default function CollegeFinder() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const found = getMatches(allColleges, data.stream ?? "", data.budget ?? "")
  ...
  const streamHrefMap: Record<string, string> = {
    "Engineering":    "/engineering-colleges-DELHI",
    "MBA":            "/mba-colleges-DELHI",
    "Medical":        "/medical-colleges-DELHI",
    "Arts & Science": "/arts-science-colleges-DELHI",
    "Law":            "/law-colleges-DELHI",
  }
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5 mb-5 mt-2">
            {[streamLabel, budgetLabel, scoreLabel, areaLabel].filter(Boolean).map((label) => (
              <span
                key={label}
                className="text-xs bg-red-50 text-red-800 border border-red-200 rounded-full px-2.5 py-0.5 font-medium"
              >
                {label}
              </span>
            ))}
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                autoComplete="name"
                className="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-3 text-sm outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 transition"
              />
            </div>
          ...
          {matches.length > 0 ? (
            <div className="space-y-3">
              ...
              {matches.length < 3 && (
                <Link
                  href={streamHref}
                  className="flex items-center justify-center gap-1.5 text-sm font-semibold text-red-700 hover:text-red-800 py-2 border border-red-200 rounded-xl hover:bg-red-50 transition-all"
                >
                  View all {streamLabel} colleges in Delhi
