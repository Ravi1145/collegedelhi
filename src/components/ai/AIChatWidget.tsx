...
const QUICK_QUESTIONS = [
  "Best BTech college in DELHI?",
  "MBA fees at FMS Delhi?",
  "Top placement colleges?",
  "DTU Delhi vs IIIT Delhi?",
]
  ...
  return (
    <>
          ...
          {!isMinimized && (
            <>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {QUICK_QUESTIONS.map((q) => (
                      <button
                        ...
                        className="text-xs bg-red-50 text-red-800 border border-red-100 px-2.5 py-1 rounded-full hover:bg-red-100 transition-colors"
                      >
                        {q}
                      </button>
                    ))}
              ...
              <div className="px-4 pb-4 pt-2 border-t border-gray-100">
                <div className="flex items-center gap-2 bg-gray-50 rounded-xl border border-gray-200 focus-within:border-red-300 px-3 py-2">
                  <input
                    ref={inputRef}
                    type="text"
                    value={input}
                    ...
                    placeholder="Ask about any DELHI college..."
                  ...
                  <button
                    ...
                    className="w-7 h-7 bg-red-600 hover:bg-red-700 disabled:opacity-40 text-white rounded-lg flex items-center justify-center transition-colors flex-shrink-0"
                  >
                    <Send className="w-3.5 h-3.5" />
                  </button>
                </div>
                <p className="text-center text-xs text-gray-400 mt-2">
                  Powered by <span className="font-medium text-red-600">Claude AI</span>
                </p>
              </div>
            </>
          )}
      ...
      <button
        ...
        className={cn(
          "fixed bottom-4 right-4 sm:right-6 z-50 w-14 h-14 bg-gradient-to-br from-red-600 to-red-700 text-white rounded-full shadow-2xl flex items-center justify-center hover:scale-110 transition-all duration-200",
          isOpen && "hidden"
        )}
