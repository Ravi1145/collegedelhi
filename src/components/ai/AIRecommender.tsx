...
const EXAM_TYPES = ["JEE Main", "JEE Main/Advanced", "NEET", "CAT", "SNAP", "MAT/CMAT", "Class 12 Merit"]
    ...
    <section className="bg-gradient-to-br from-[#0A1628] to-[#1E3A5F] rounded-3xl p-8 lg:p-12">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 bg-red-600/20 text-red-300 text-sm font-medium px-4 py-2 rounded-full mb-4">
            <Brain className="w-4 h-4" />
            AI-Powered Recommendations
          </div>
          <h2 className="text-3xl font-bold text-white mb-3">Find Your Perfect College in DELHI</h2>
          <p className="text-gray-400 max-w-xl mx-auto">
            Tell us about your preferences and let our AI analyze 25+ DELHI colleges to find your best match
          </p>
        </div>
        ...
        {!result ? (
          <div className="bg-white/10 backdrop-blur rounded-2xl p-6 lg:p-8 space-y-6">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      form.stream === s
                        ...
                        : "border-white/20 text-gray-300 hover:border-red-400 hover:text-white"
                    )}
                  >
                    {s}
                  </button>
            ...
            <div>
              <label className="text-white font-semibold text-sm mb-3 block">
                Annual Budget: <span className="text-red-400">₹{(form.budget / 100000).toFixed(1)}L/yr</span>
              </label>
              <input
                type="range"
                min={0}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 text-white rounded-xl px-3 py-2.5 text-sm outline-none focus:border-red-400 placeholder-gray-400"
                />
              </div>
            </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      form.preferences.includes(pref)
                        ...
                        : "border-white/20 text-gray-300 hover:border-red-400"
                    )}
                  >
                    {pref}
                  </button>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-red-600 hover:bg-red-700 disabled:opacity-60 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 text-base transition-colors"
            >
              {loading ? (
                <>
              ...
              {result.colleges.map((college, i) => (
                <div key={i} className="bg-white rounded-2xl overflow-hidden">
                  <div className="bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] px-5 py-3 flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-red-400">{college.matchScore}%</span>
                  </div>
                  <div className="p-5">
                    ...
                    {college.admissionTip && (
                      <div className="bg-red-50 rounded-xl p-3 mb-4">
                        <p className="text-xs font-semibold text-red-800 mb-1">Admission Tip</p>
                        <p className="text-xs text-red-700">{college.admissionTip}</p>
                      </div>
                    )}
                    <div className="flex gap-2">
                      ...
                      <a
                        href="#"
                        className="flex-1 bg-red-600 text-white text-sm font-semibold py-2.5 rounded-xl text-center hover:bg-red-700 transition-colors"
                      >
                        Apply Now
                      </a>
                    </div>
