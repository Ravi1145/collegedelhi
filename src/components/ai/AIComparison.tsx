...
import type { College, AIComparisonResult } from "@/types"
...
export default function AIComparison() {
  ...
  const col1Data = allColleges.find((c) => c.slug === college1)
  const col2Data = allColleges.find((c) => c.slug === college2)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3 items-center">
          <div className="sm:col-span-2">
            ...
            <select
              ...
              className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm text-gray-800 outline-none focus:border-red-400 bg-white"
            >
        ...
        <button
          ...
          className="mt-5 w-full sm:w-auto bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white font-bold px-8 py-3 rounded-xl flex items-center gap-2 transition-colors"
        >
          {loading ? (
            <>
