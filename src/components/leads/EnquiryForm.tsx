    ...
    try {
      ...
      const res = await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          course_interest:   form.course || undefined,
          message:           form.message || undefined,
          preferred_contact: form.preferred_contact,
          preferred_time:    form.preferred_time || undefined,
          source:            "enquiry_form" as const,
      ...
      if (data.success) {
        localStorage.setItem("last_enquiry", JSON.stringify({ college: collegeName, ref: data.bookingRef ?? data.leadId }))
        setSuccess({ bookingRef: data.bookingRef ?? `REF-${data.leadId ?? Date.now()}` })
      } else {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        {/* Orange top bar */}
        <div className="h-2 bg-gradient-to-r from-red-400 to-red-700 rounded-t-2xl" />
        ...
        <div className="px-6 pt-5 pb-4 border-b border-gray-100">
          ...
          <p className="text-sm text-red-700 font-medium mt-0.5">Get Free Admission Info</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={cn(
                  ...
                  errors.name ? "border-red-400 focus:border-red-500" : "border-gray-200 focus:border-red-400"
                )}
              />
            ...
            <div>
              ...
              <input
                ...
                className={cn(
                  "w-full border rounded-xl px-3 py-2.5 text-sm outline-none transition-colors",
                  errors.phone ? "border-red-400 focus:border-red-500" : "border-gray-200 focus:border-red-400"
                )}
              />
              {errors.phone
            ...
            <div>
              ...
              <input
                ...
                className={cn(
                  "w-full border rounded-xl px-3 py-2.5 text-sm outline-none transition-colors",
                  errors.email ? "border-red-400 focus:border-red-500" : "border-gray-200 focus:border-red-400"
                )}
              />
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 disabled:opacity-60 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 transition-all text-sm"
            >
              {loading ? (
