  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const bookingDetails = [
        ...
        form.preferred_date ? `Date: ${form.preferred_date}` : "",
        form.preferred_time ? `Time: ${form.preferred_time}` : "",
      ].filter(Boolean).join(", ")
      ...
      const res = await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          message:      bookingDetails || undefined,
      ...
      if (data.success) {
        setSuccess({ bookingRef: data.leadId ? `CP-${data.leadId}` : "Confirmed" })
        setForm(initialForm)
      } else {
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-center">
          ...
          <div className="text-white">
            ...
            <p className="text-blue-100 text-base mb-6">
              Talk to our DELHI education experts. Get personalized guidance on colleges, courses, fees, and admission strategy — completely free.
            </p>
            ...
            {success ? (
              <div className="text-center py-8">
                ...
                <button
                  ...
                  className="mt-5 text-sm text-red-700 hover:text-red-800 font-medium underline"
                >
