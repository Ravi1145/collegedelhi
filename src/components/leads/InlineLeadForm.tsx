    ...
    <div className="border-l-4 border-red-600 bg-red-50 rounded-xl p-4">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
        <div className="flex-1 min-w-0">
          <input
            ...
            className={cn(
              ...
              errors.name ? "border-red-400" : "border-gray-200 focus:border-red-400"
            )}
          />
        ...
        <button
          ...
          className="bg-red-600 hover:bg-red-700 disabled:opacity-60 text-white font-bold px-4 py-2 rounded-lg flex items-center justify-center gap-1.5 transition-colors text-sm whitespace-nowrap"
        >
          {loading ? (
