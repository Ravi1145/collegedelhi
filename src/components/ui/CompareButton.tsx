...
export function CompareFloatingBar() {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-40 bg-[#0A1628] text-white rounded-2xl shadow-2xl px-5 py-3 flex items-center gap-4 border border-white/10">
      <GitCompare className="w-5 h-5 text-red-400 flex-shrink-0" />
      ...
      {compareList.length === 2 && (
        <button
          ...
          className="bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-4 py-1.5 rounded-lg flex items-center gap-1.5 transition-colors"
        >
