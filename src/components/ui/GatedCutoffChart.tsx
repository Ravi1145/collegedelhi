        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-5 max-w-sm w-full mx-4 text-center">
          ...
          <form onSubmit={handleUnlock} className="space-y-3">
            <input
              ...
              className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100"
              maxLength={10}
            />
            ...
            <label className="flex items-start gap-2 cursor-pointer text-left">
              ...
              <span className="text-[10px] text-gray-400">
                I agree to the{" "}
                <a href="/terms" className="text-red-600 underline">Terms &amp; Conditions</a>
                {" "}and{" "}
