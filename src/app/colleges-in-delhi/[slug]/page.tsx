...
function filterColleges(page: ReturnType<typeof getSEOPageBySlug>): College[] {
  ...
  if (slug === "top-placement-colleges-delhi") {
    return [...colleges]
  ...
  if (slug === "naac-a-plus-colleges-delhi") {
    return colleges.filter((c) => c.naac === "A++" || c.naac === "A+")
  }

  if (slug === "nirf-ranked-colleges-Delhi") {
    return [...colleges]
      .filter((c) => c.nirfRank != null)
      .sort((a, b) => (a.nirfRank ?? 999) - (b.nirfRank ?? 999))
  }

  if (slug === "btech-computer-science-colleges-Delhi") {
  ...
  if (slug === "mba-finance-colleges-Delhi") {
    return colleges.filter(
      (c) =>
        c.stream === "MBA" &&
  ...
  if (slug === "mba-marketing-colleges-Delhi") {
    return colleges.filter(
      (c) =>
        c.stream === "MBA" &&
