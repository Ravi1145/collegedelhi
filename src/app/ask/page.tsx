      ...
      <div className="bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] py-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold text-white mb-2">
            Ask a Delhi College Question
          </h1>
          <p className="text-gray-300">Get answers from CollegeDelhi counsellors and Delhi college alumni. 100% free.</p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="e.g. What is the JEE Main cutoff for DTU Delhi CSE branch in 2026? What documents are needed for DTU Delhi hostel?"
                    rows={4}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm outline-none focus:border-red-400 focus:ring-2 focus:ring-red-100 resize-none"
                  />
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white font-bold py-3 rounded-xl text-sm transition-colors"
                >
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <button
                    ...
                    className="block w-full text-left text-xs text-red-700 hover:text-red-800 py-1 border-b border-gray-50 last:border-0"
                  >
                    → {q}
                  </button>
                ))}
            ...
            <Link href="/qa" className="block bg-gradient-to-br from-red-50 to-amber-50 border border-red-100 rounded-2xl p-4 text-center hover:shadow-md transition-shadow">
