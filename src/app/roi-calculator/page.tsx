    ...
    <div className="bg-surface min-h-screen">
      ...
      <div className="bg-gradient-to-br from-[#0A1628] to-[#1E3A5F] py-12 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-200 max-w-xl mx-auto">
            Calculate the real return on investment for any Delhi college course — break-even point, 10-year earnings, and net ROI.
          </p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-5 flex items-center gap-2">
              <Calculator className="w-5 h-5 text-red-600" /> Your Inputs
            </h2>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 text-sm transition-colors"
              >
      ...
      <div className="bg-white border-t border-gray-100 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Is Your Delhi College Worth the Investment?</h2>
          <p className="text-gray-600 text-sm leading-relaxed mb-6">
            The CollegeDelhi ROI Calculator helps you decide whether a college is a good financial investment. Compare total fees against expected salary, estimate your payback period, and project 10-year earnings for any Delhi college — covering B.Tech, MBA, MBBS, BCA, BBA, LLB, and more.
          </p>
          <div className="grid sm:grid-cols-3 gap-4 mb-6">
            {[
              { college: "DTU Delhi (B.Tech)", fees: "₹3.2L–₹7.2L total", salary: "₹12 LPA avg", payback: "~3–7 months" },
              { college: "FMS Delhi (MBA)", fees: "₹16L–₹22L total", salary: "₹28 LPA avg", payback: "~8–10 months" },
              { college: "AIIMS Delhi (MBBS)", fees: "₹50K total", salary: "₹9–12 LPA", payback: "< 1 month" },
            ].map(({ college, fees, salary, payback }) => (
              <div key={college} className="bg-red-50 border border-red-100 rounded-xl p-4">
          ...
          <h2 className="text-lg font-bold text-gray-900 mb-3">Best ROI colleges in Delhi 2026</h2>
          <p className="text-sm text-gray-600 leading-relaxed">
            <strong>For Engineering:</strong> DTU Delhi offers the best ROI — government fees of ₹80K/yr vs ₹12 LPA average placement. NSUT Delhi offers strong ROI for CS/IT (₹1.4–1.9L fees, ₹7.5 LPA avg). <strong>For MBA:</strong> Jaipuria Institute of Management Noida (₹4.2–6.5L total fees, ₹7.2 LPA avg) and IMI Delhi (₹7–11L, ₹12 LPA avg) offer better ROI than FMS Delhi if cost is a priority. <strong>For Medical:</strong> AIIMS Delhi is unbeatable — near-zero fees, a prestigious armed forces medical career with service obligation, and unmatched national recognition.
          </p>
        </div>
      </div>
    </div>
