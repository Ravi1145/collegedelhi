...
export const metadata: Metadata = genMeta({
  ...
  keywords: [
    ...
    "engineering colleges Delhi highest package",
    "mba colleges Delhi highest package",
    "internship engineering colleges Delhi",
    "job oriented engineering colleges Delhi",
    "placement comparator Delhi colleges",
  ],
})

const engineeringData = [
  { name: "DTU Delhi", type: "Government", avg: "₹12 LPA", highest: "₹45 LPA", rate: "92%", recruiters: "TCS, Bajaj, Mercedes, Siemens, L&T" },
  { name: "IMI Delhi", type: "Deemed", avg: "₹9.8 LPA", highest: "₹42 LPA", rate: "94%", recruiters: "Google, Microsoft, Capgemini, Wipro, Honeywell" },
  { name: "IIIT Delhi", type: "Autonomous", avg: "₹8.5 LPA", highest: "₹40 LPA", rate: "88%", recruiters: "TCS, Infosys, Bajaj Auto, Bosch, Cummins" },
  { name: "NSUT Delhi", type: "Autonomous", avg: "₹7.5 LPA", highest: "₹35 LPA", rate: "90%", recruiters: "Goldman Sachs, Amazon, Deutsche Bank, Persistent" },
  { name: "Amity University Delhi Delhi", type: "Deemed", avg: "₹7.2 LPA", highest: "₹38 LPA", rate: "85%", recruiters: "TCS, Wipro, Capgemini, Tech Mahindra, Accenture" },
  { name: "IGDTUW Delhi", type: "Autonomous", avg: "₹6.8 LPA", highest: "₹28 LPA", rate: "87%", recruiters: "Cummins, Eaton, Emerson, Tata Technologies" },
  { name: "GL Bajaj NIET", type: "Private", avg: "₹5.2 LPA", highest: "₹22 LPA", rate: "78%", recruiters: "TCS, Infosys, Wipro, HCL, Hexaware" },
  { name: "NIET Noida College", type: "Private", avg: "₹4.8 LPA", highest: "₹20 LPA", rate: "75%", recruiters: "TCS, Wipro, Zensar, Persistent, Cognizant" },
  { name: "Sharda College", type: "Private", avg: "₹4.9 LPA", highest: "₹18 LPA", rate: "76%", recruiters: "TCS, Infosys, HCL, Mphasis, NIIT Technologies" },
]

const mbaData = [
  { name: "FMS Delhi", type: "Deemed", avg: "₹28 LPA", highest: "₹65 LPA", rate: "100%", recruiters: "McKinsey, BCG, Goldman Sachs, P&G, Deloitte" },
  { name: "MDI Gurgaon", type: "Deemed", avg: "₹22 LPA", highest: "₹55 LPA", rate: "100%", recruiters: "Amazon, Accenture, Capgemini, EY, KPMG" },
  { name: "BIMTECH Delhi", type: "Deemed", avg: "₹18 LPA", highest: "₹45 LPA", rate: "98%", recruiters: "Microsoft, TCS, Cognizant, Infosys BPM, Wipro" },
  { name: "IMI Delhi", type: "Autonomous", avg: "₹12 LPA", highest: "₹32 LPA", rate: "92%", recruiters: "HDFC Bank, ICICI, Bajaj Finserv, Mahindra, Tata" },
  { name: "Fore School Delhi", type: "Autonomous", avg: "₹8.5 LPA", highest: "₹22 LPA", rate: "88%", recruiters: "HDFC, Axis Bank, Reliance, HUL, Aditya Birla" },
  { name: "Indira Institute", type: "Autonomous", avg: "₹7.2 LPA", highest: "₹18 LPA", rate: "85%", recruiters: "Delhi-based SMEs, BFSI companies, FMCG firms" },
  { name: "IMS Ghaziabad", type: "Private", avg: "₹5.8 LPA", highest: "₹14 LPA", rate: "80%", recruiters: "Local Delhi companies, Banking sector, Insurance" },
]
...
const faqs = [
  {
    question: "Which Delhi engineering college has the highest average placement package?",
    answer: "DTU Delhi (College of Engineering Delhi) has the highest average placement package among engineering colleges in Delhi at ₹12 LPA (2024–25). IMI Delhi is second at ₹9.8 LPA avg, followed by IIIT Delhi at ₹8.5 LPA avg. The highest individual package at Delhi engineering colleges is ₹45 LPA at DTU Delhi (Mercedes-Benz, international tech firms).",
  },
  {
  ...
  },
  {
    ...
    answer: "The average placement package at IIIT Delhi (Indraprastha Institute of Information Technology) is ₹8.5 LPA for the 2024–25 batch. The highest package was ₹40 LPA. Top recruiters include Bajaj Auto, Bosch, Cummins, TCS, Infosys, and Capgemini. IIIT Delhi is particularly strong for Mechanical and Electronics placements in the Delhi automotive/manufacturing sector.",
  },
  {
    question: "Do private engineering colleges in Delhi have good placements?",
    answer: "Private engineering colleges in Delhi have decent but not exceptional placements compared to government/autonomous colleges. GL Bajaj NIET averages ₹5.2 LPA, NIET Noida averages ₹4.8 LPA, Sharda College averages ₹4.9 LPA. Most private college placements are dominated by TCS, Infosys, Wipro, HCL mass recruiters. For better placements, target NSUT, IIIT Delhi, or IMI Delhi over generic private colleges.",
  },
  {
    question: "What is the placement percentage at FMS Delhi?",
    answer: "FMS Delhi achieves near 100% placement for its MBA batch. The 2024 batch saw 100% placement with average salary of ₹28 LPA and highest international package of ₹65 LPA. McKinsey, BCG, P&G, Goldman Sachs, and Hindustan Unilever are among the top recruiters visiting FMS Delhi campus annually.",
  },
]

const breadcrumbs = [
  { name: "Home", url: "/" },
  { name: "Tools", url: "/delhi-college-placement-comparator" },
  { name: "Placement Comparator", url: "/delhi-college-placement-comparator" },
]

export default function DELHICollegePlacementComparatorPage() {
        ...
        <div className="bg-gradient-to-br from-[#0A1628] to-[#1E3A5F] py-10 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-white mb-3">
              Delhi College Placement Comparator 2026
            </h1>
            <p className="text-blue-200 text-sm max-w-2xl">
              Compare average salary, highest package, and placement % across Delhi engineering and MBA colleges. Select up to 4 colleges and see side-by-side bar charts.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mt-8 mb-6">
            <div className="px-5 py-4 border-b border-gray-100">
              <h2 className="text-lg font-bold text-gray-900">Engineering College Placements in Delhi 2026</h2>
                ...
                <tbody className="divide-y divide-gray-50">
                  {engineeringData.map((c) => (
                    <tr key={c.name} className="hover:bg-blue-50/20">
                      ...
                      <td className="px-4 py-3 text-right text-sm text-red-800 hidden sm:table-cell">{c.highest}</td>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
            <div className="px-5 py-4 border-b border-gray-100">
              <h2 className="text-lg font-bold text-gray-900">MBA College Placements in Delhi 2026</h2>
                ...
                <tbody className="divide-y divide-gray-50">
                  {mbaData.map((c) => (
                    <tr key={c.name} className="hover:bg-red-50/20">
                      ...
                      <td className="px-4 py-3 text-right text-sm text-red-800 hidden sm:table-cell">{c.highest}</td>
                      <td className="px-4 py-3 text-center hidden md:table-cell">
                        <span className="text-xs bg-red-50 text-red-800 px-2 py-0.5 rounded-full font-semibold">{c.rate}</span>
                      </td>
                      <td className="px-4 py-3 text-xs text-gray-500 hidden lg:table-cell">{c.recruiters}</td>
                    </tr>
                  ))}
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-8">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Top Recruiters at Delhi Colleges by Sector</h2>
          ...
          {/* FAQ */}
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-5">FAQs — Delhi College Placements 2026</h2>
            <div className="space-y-3">
              {faqs.map((faq, i) => (
