...
export const metadata: Metadata = genMeta({
  ...
  keywords: [
    ...
    "colleges in Delhi with low fees engineering",
    "engineering college scholarship Delhi",
    "DTU Delhi scholarship",
    "engineering scholarship Delhi 2026",
    "merit scholarship engineering Delhi",
    "sc st scholarship engineering Delhi",
  ],
})
...
const collegeScholarships = [
  ...
  },
  {
    ...
    type: "Private",
    naac: "A",
    scheme: "Sharda Merit & Need-Based Scholarship",
    eligibility: "EBC / SC/ST via government scheme; Merit: 75+ percentile JEE Main",
...
const govtScholarships = [
  {
    ...
    portal: "NSP Delhi Scholarship (NSP Delhi Scholarship.Delhi.gov.in)",
  ...
  },
  {
    ...
    portal: "NSP Delhi Scholarship portal — post-matric scholarship",
  ...
  },
  {
    ...
    portal: "NSP Delhi Scholarship portal — OBC scholarship",
    deadline: "Before November every academic year",
  },
  {
    scheme: "Delhi Merit Scholarship (Top JEE Main Rankers)",
    eligibility: "Students in top 10% of JEE Main; 75%+ in HSC",
...
const faqs = [
  {
    question: "Which engineering colleges in Delhi offer scholarships?",
    answer:
      "Most engineering colleges in Delhi offer scholarships through government schemes. DTU Delhi (government) automatically provides EBC/SC/ST/OBC fee waivers. IIIT Delhi offers institutional merit scholarships of ₹25,000–₹50,000/year for students with 95+ percentile in JEE Main. IMI Delhi offers merit fellowships of ₹50,000–₹2L/year for top SET/JEE rankers. NSUT, Sharda, and GL Bajaj also offer merit scholarships for high-percentile students.",
  },
  {
    question: "How to get scholarship in engineering college in Delhi?",
    answer:
      "To get a scholarship for engineering college in Delhi: (1) Apply for EBC scholarship via NSP Delhi Scholarship portal if family income is below ₹8L/year. (2) SC/ST students should apply for post-matric scholarship on NSP Delhi Scholarship before October. (3) For merit scholarships, maintain 95+ percentile in JEE Main. (4) For AICTE scholarships, apply via NSP portal (scholarships.gov.in) after college admission. (5) Check with your college's scholarship cell for institutional scholarships. Apply early — most deadlines are in October–November.",
  },
  {
    question: "What is EBC scholarship for engineering in Delhi?",
    answer:
      "EBC (Economically Backward Class) scholarship is a Delhi government scheme for students from non-SC/ST/OBC families with income below ₹8 lakh per year. EBC scholarship provides 50% tuition fee waiver at all government and government-aided engineering colleges. Students must apply via NSP Delhi Scholarship portal within 3 months of admission. Documents required: income certificate, caste certificate (non-SC/ST proof), Aadhar, admission receipt, and bank account details.",
  },
  {
    question: "Do SC/ST students get free engineering education in Delhi?",
    answer:
      "Yes, SC (Scheduled Caste) and ST (Scheduled Tribe) students get full tuition fee waiver at all government and government-aided engineering colleges in Delhi including DTU Delhi. The Delhi government's post-matric scholarship covers 100% tuition fees plus ₹1,200/year for books and stationery. Students must apply via NSP Delhi Scholarship portal every year before November. There is no income limit for SC/ST fee waivers.",
  },
  {
    question: "What is the DTU Delhi merit scholarship?",
    answer:
      "DTU (Delhi Technological University) offers institutional merit scholarships for top-performing students. Students who maintain a CGPA above 8.5/10 in the first year are eligible for merit scholarships of ₹10,000–₹25,000/year from the college's alumni fund. Additionally, DTU Delhi students can avail government scholarships (EBC, SC/ST, OBC) and AICTE scholarships simultaneously. The Dr. A.P.J. Abdul Kalam merit scholarship is also available at DTU Delhi for students in financial need.",
  },
  {
    question: "Can I apply for AICTE scholarship at any Delhi engineering college?",
    answer:
      "You can apply for AICTE scholarships (Pragati, Saksham) at any AICTE-approved engineering college in Delhi. This includes DTU Delhi, IIIT Delhi, NSUT, IMI Delhi, GL Bajaj, NIET Noida, Sharda, and Indira College. Application is through the NSP (National Scholarship Portal) at scholarships.gov.in. You must apply within 3 months of admission confirmation. Pragati scholarship (for girl students) offers ₹50,000/year and requires family income below ₹8L/year.",
  },
  {
    question: "Which is the best scholarship for engineering students in Delhi?",
    answer:
      "The best scholarships for engineering students in Delhi are: (1) SC/ST Post-Matric Scholarship — full fee waiver, no income limit. (2) EBC Scholarship — 50% fee waiver for family income below ₹8L. (3) AICTE Pragati Scholarship — ₹50,000/year for girl students. (4) Central Sector Scholarship (CSSS) — ₹12,000–₹20,000/year for 80%+ in 12th. (5) OBC Scholarship — 25–50% fee reduction. Apply for all applicable scholarships as they can be combined in some cases.",
  },
]
...
const breadcrumbs = [
  ...
  { name: "Engineering Colleges Delhi Scholarship", url: "/engineering-colleges-delhi-scholarship" },
]

const applySteps = [
  "Check eligibility: income certificate, caste certificate, JEE Main scorecard",
  "Register on NSP Delhi Scholarship portal (NSP Delhi Scholarship.Delhi.gov.in) with Aadhar-linked mobile",
  ...
  "Track application status on NSP Delhi Scholarship dashboard",
  "Scholarship amount directly credited to bank account via DBT",
]

export default function EngineeringCollegesDELHIScholarshipPage() {
        ...
        <div className="bg-gradient-to-br from-[#0A1628] to-[#1E3A5F] py-12 px-4">
          <div className="max-w-5xl mx-auto">
            <nav className="text-xs text-blue-300 mb-4 flex flex-wrap items-center gap-1">
              ...
              <span>›</span>
              <span className="text-white">Engineering Colleges Delhi Scholarship</span>
            </nav>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-4 leading-tight">
              Engineering colleges in Delhi with Scholarship 2026
            </h1>
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <Award className="w-5 h-5 text-red-600" /> Delhi Government Scholarships for Engineering
            </h2>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
            <div className="px-5 py-4 border-b border-gray-100">
              <h2 className="text-lg font-bold text-gray-900">Scholarships at Top Delhi Engineering Colleges — 2026</h2>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <BookOpen className="w-5 h-5 text-red-600" /> Private & Institutional Scholarships in Delhi
            </h2>
            <div className="grid sm:grid-cols-3 gap-4">
              {[
                {
                  college: "DTU Delhi Merit Scholarship",
                  detail: "Students maintaining CGPA 8.5+ in year 1 get ₹10,000–₹25,000/year from DTU Delhi alumni fund. Dr. Kalam scholarship for needy students.",
                  badge: "Government",
                },
                {
                  college: "IIIT Delhi Scholarship",
                  detail: "Merit scholarship of ₹25,000–₹50,000/year for students with 95+ percentile in JEE Main or 90%+ in 12th boards. Apply at admission time.",
                  badge: "Autonomous",
                },
                {
                ...
                <div key={college} className="bg-gray-50 rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs bg-red-100 text-red-800 px-2 py-0.5 rounded-full">{badge}</span>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <CheckCircle className="w-5 h-5 text-red-600" /> How to Apply for Scholarships — Step by Step
            </h2>
            <ol className="space-y-3">
              {applySteps.map((step, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="w-6 h-6 bg-red-600 text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">{i + 1}</span>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <Award className="w-5 h-5 text-red-600" /> National Scholarships for Engineering Students
            </h2>
            <div className="space-y-4">
          ...
          {/* FAQ Section */}
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-5">Frequently Asked Questions — Engineering Scholarships in Delhi</h2>
