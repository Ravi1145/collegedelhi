...
const faqs = [
  ...
  { q: "What exams are needed for MBA Digital Marketing admission in Delhi 2026?", a: "MBA Digital Marketing admission in Delhi NCR 2026 requires: CAT (for IMI Delhi, LBSIM Delhi, BIMTECH). MICAT (for MICA, Ahmedabad) — tests creative and analytical abilities, not just quantitative aptitude. Amity's own AUAT test (no CAT required). IPU CET for IPU-affiliated MBA Marketing programmes. For pure digital marketing skills without MBA, Google Career Certificates, Meta Blueprint, and HubSpot Academy are industry-recognised alternatives." },
  ...
  return (
    <>
      ...
      <SEOLandingPage
        ...
        admissionSteps={[
          { step: "1", title: "Choose Right Exam Based on Target College", description: "CAT: IMI Delhi, LBSIM Delhi, BIMTECH, FORE School. MICAT: MICA — a two-phase test covering psychometric, creative, and analytical sections, very different from CAT and needing specific prep. AUAT: Amity University's own entrance exam. Strategy: target colleges based on your CAT percentile range, and start MICAT prep separately if interested in MICA." },
