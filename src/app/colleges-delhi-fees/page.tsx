    ...
    <>
      ...
      <SEOLandingPage
        ...
        whyPoints={[
          ...
          { title: "Deemed University Fee Premiums", description: "Deemed and private universities (Amity University Delhi and similar) set their own fees above government regulation. However, they offer premium placements, infrastructure, and international exposure justifying the cost." },
