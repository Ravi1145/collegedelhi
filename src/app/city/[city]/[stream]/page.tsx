...
const VALID_CITIES  = ["Delhi", "noida", "gurugram", "greater-noida", "ghaziabad", "faridabad"]
...
export async function generateStaticParams() {
  ...
  // Pre-generate Delhi pages at build time
  for (const stream of VALID_STREAMS) {
    params.push({ city: "Delhi", stream })
  }
  return params
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return genMeta({
    title: `Best ${streamLabel} Colleges in ${cityLabel} 2026 — Fees, Cutoff & Admissions | CollegeDelhi`,
    description: `Explore top ${streamLabel} colleges in ${cityLabel}, Delhi. Compare fees, NAAC grades, placements and get free counseling. Updated 2026.`,
        ...
        <div className="bg-[#0A1628] text-white">
          <div className="max-w-6xl mx-auto px-4 py-10 md:py-14">
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-orange-400 text-sm font-medium">{cityLabel}, Delhi</span>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="text-sm font-bold text-gray-900">Delhi</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="space-y-1.5">
                  {["Delhi", "noida", "gurugram", "greater-noida", "ghaziabad"]
                    .filter(c => c !== city)
                    .map(c => (
                      <Link
                        key={c}
