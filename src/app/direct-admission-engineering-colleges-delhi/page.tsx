...
export const metadata: Metadata = genMeta({
  ...
  keywords: [
    ...
    "engineering direct admission Delhi",
    "direct admission in engineering colleges Delhi",
    "management quota engineering Delhi",
...
const managementQuotaColleges = [
  ...
  },
  {
    ...
    note: "Best MQ availability in Delhi",
  },
  {
    name: "NIET Noida",
    quota: "~30%",
...
const faqs = [
  {
    question: "Is management quota admission legal in Delhi engineering colleges?",
    answer:
  ...
  {
    question: "Does DTU Delhi have management quota seats?",
    answer:
  ...
  {
    question: "What documents are required for direct admission in Delhi engineering college?",
    answer:
  ...
  {
    question: "Can I get direct BTech admission in Delhi without any entrance exam?",
    answer:
...
const breadcrumbs = [
  ...
  { name: "Direct Admission Engineering Delhi", url: "/direct-admission-engineering-colleges-delhi" },
]
      ...
      <div className="bg-surface min-h-screen">
        ...
        <div className="bg-gradient-to-br from-[#0A1628] to-[#1E3A5F] py-12 px-4">
          <div className="max-w-5xl mx-auto">
            <nav className="text-xs text-blue-300 mb-4 flex flex-wrap items-center gap-1">
              ...
              <span>›</span>
              <span className="text-white">Direct Admission Engineering Delhi</span>
            </nav>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-4 leading-tight">
              Direct Admission in Engineering Colleges Delhi 2026
            </h1>
            <p className="text-blue-200 text-base max-w-3xl mb-6">
              Complete guide to management quota, NRI quota, and direct BTech admission in Delhi 2026. Fees, eligibility,
            ...
            <div className="bg-white/10 border border-white/20 rounded-2xl p-5 max-w-3xl mb-6">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                colleges in Delhi. <strong>DTU Delhi and government colleges don&apos;t offer management quota</strong> — only
                JAC Delhi Rounds. Colleges like IIIT Delhi, Amity University Delhi, IMI Delhi, GL Bajaj, and NIET Noida have 10–30% management quota
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            {[
              { label: "Colleges with MQ", value: "20+", icon: "" },
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <BookOpen className="w-5 h-5 text-red-600" /> What is Direct / Management Quota Admission?
            </h2>
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-gray-900 mb-2 text-sm">JAC Delhi Rounds (Regular Admission)</h3>
                <ul className="space-y-2">
                  {[
                    "Conducted by DTE Delhi centrally",
                    "Based on JEE Main or JEE Main merit rank",
                    "Covers 70–90% of available seats",
                    "Lower fees — government regulated",
                    "Transparent, competitive process",
                    "DTU Delhi, NSUT, VIT, GL Bajaj, NIET Noida all participate",
                  ].map((item, i) => (
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    "Higher fees — approved by FRA Delhi",
            ...
            <div className="mt-4 bg-amber-50 border border-amber-200 rounded-xl p-4">
              <p className="text-sm text-amber-800">
                <strong>Important:</strong> Government colleges (DTU Delhi, SCOE, PVPIT) have 0% management quota — 100% of
                their seats go through DTE JAC Delhi Rounds. Management quota is only for private and deemed universities
                approved by AICTE.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
            <div className="px-5 py-4 border-b border-gray-100">
              <h2 className="text-lg font-bold text-gray-900">
                Engineering colleges in Delhi with Management Quota — 2026
              </h2>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <Users className="w-5 h-5 text-red-600" /> NRI Quota Engineering colleges in Delhi
            </h2>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <BookOpen className="w-5 h-5 text-red-600" /> Step-by-Step Direct Admission Process
            </h2>
            <ol className="space-y-3">
              {[
                ...
                <li key={i} className="flex items-start gap-3">
                  <span className="w-7 h-7 bg-red-600 text-white rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5">
                    {i + 1}
                  </span>
                  <div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-8">
            <div className="px-5 py-4 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-400 mt-0.5">Annual fee comparison at popular Delhi engineering colleges</p>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
            ...
            <div className="px-5 py-3 bg-amber-50 border-t border-amber-100">
              <p className="text-xs text-amber-800">
                ...
                with the Fee Regulating Authority (FRA) Delhi approved fee schedule.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 sm:p-6 mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-3 flex items-center gap-2">
              <AlertCircle className="w-5 h-5 text-red-600" /> Is Direct/Management Quota Admission Legal?
            </h2>
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-4">
              ...
              <p className="text-sm text-green-700 leading-relaxed">
                AICTE (All India Council for Technical Education) and DTE Delhi regulate management quota
                admissions. All private and deemed colleges are permitted to fill a specified percentage of seats through
                institute-level admissions. Fees are capped by the Fee Regulating Authority (FRA) of Delhi.
              </p>
            </div>
            <ul className="space-y-2">
              {[
                "AICTE approval required for all technical institutions",
                "Fees approved and capped by FRA Delhi",
                "DTE Delhi monitors MQ admissions via online portal",
                "Students get same degree as JAC Delhi Round students",
                "No capitation fees allowed — any demand is illegal",
                "Complaint mechanism available at DTE Delhi helpline",
              ].map((item, i) => (
          ...
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-5">
              Frequently Asked Questions — Direct Admission in Engineering Colleges Delhi
            </h2>
