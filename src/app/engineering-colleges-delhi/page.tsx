...
const colleges = [
  ...
  { rank: 2, name: "DTU – Delhi Technological University", type: "Government (State)", nirf: 49, naac: "A+", fees: "₹1.5L–2L/yr", placement: "₹18 LPA avg | ₹72 LPA highest", exam: "JEE Main (JAC Delhi)", slug: "dtu-delhi", highlight: "Best Govt. | Highest Placements" },
  { rank: 3, name: "NSUT – Netaji Subhas University of Technology", type: "Government (State)", nirf: 52, naac: "A+", fees: "₹1.5L–2L/yr", placement: "₹16 LPA avg | ₹65 LPA highest", exam: "JEE Main (JAC Delhi)", slug: "nsut-delhi", highlight: "NIRF 52 | Strong CS Placements" },
  { rank: 4, name: "IGDTUW – Indira Gandhi Delhi Technical University for Women", type: "Government (State)", nirf: 78, naac: "A+", fees: "₹1.2L–1.8L/yr", placement: "₹14 LPA avg | ₹55 LPA highest", exam: "JEE Main (JAC Delhi)", slug: "igdtuw-delhi", highlight: "Best Women's Engineering College" },
  ...
  { rank: 6, name: "Jamia Millia Islamia – Faculty of Engineering", type: "Central University", nirf: 14, naac: "A+", fees: "₹80K–1.5L/yr", placement: "₹10 LPA avg | ₹42 LPA highest", exam: "JEE Main / CUET", slug: "jmi-delhi", highlight: "Central University | Affordable Fees" },
