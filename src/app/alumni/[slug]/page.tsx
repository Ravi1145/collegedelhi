...
const allAlumni = [
  {
    ...
    highlights: [
      ...
      "Captain of DTU Robotics Team",
    ],
  },
  {
    slug: "priya-desai-fms-2022",
    name: "Priya Desai",
    college: "FMS Delhi",
    course: "MBA",
    year: 2022,
    company: "McKinsey & Co.",
    package: "₹28 LPA",
    bio: "Specialised in strategy consulting. Led FMS Delhi consulting club.",
    highlights: [
  ...
  },
  {
    ...
    company: "Microsoft",
    package: "₹25 LPA",
    bio: "Full-stack developer. Won multiple hackathons. Core team ACM IIIT Delhi.",
    highlights: [
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return genMeta({
    title: `${name} — ${course} at ${college} | CollegeDelhi Alumni`,
    description: `${name} graduated from ${college} with ${course} (${alumni.year}). Now at ${alumni.company}. Read highlights and connect with verified Delhi alumni.`,
    path: `/alumni/${slug}`,
    keywords: [
      `${college} alumni`,
      `${college} placement`,
      `${college} ${course}`,
      "Delhi college alumni",
    ],
  })
}
