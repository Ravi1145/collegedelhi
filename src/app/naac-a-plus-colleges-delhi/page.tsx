...
const faqs = [
  ...
  { q: "How many NAAC A+ colleges are there in Delhi?", a: "Delhi has approximately 15-20 NAAC A+ graded colleges across engineering, management, arts, and medical streams. Key A+ institutions include DTU Delhi, Amity University Delhi, Symbiosis University, IIIT Delhi, IGDTUW Delhi, Miranda House College, and SNDT Women's University." },
  ...
  { q: "Which NAAC A+ college in Delhi has the lowest fees?", a: "Miranda House College (NAAC A+, government autonomous) has fees from ₹25,000/year for BA/BSc programs. SNDT Women's University (NAAC A+) charges ₹30-60K/year. DTU Delhi (NAAC A+) charges ₹80K/year for engineering -- the best value among NAAC A+ technical colleges." },
  { q: "What programs are available in NAAC A+ colleges in Delhi?", a: "NAAC A+ colleges in Delhi offer all major programs: Engineering (DTU Delhi, IIIT Delhi, Amity University Delhi), MBA (Symbiosis, Amity University Delhi), Arts & Science (Fergusson, SNDT), Medical (MAMC), Law (Symbiosis Law), and Design programs. The full spectrum of UG and PG programs is available across A+ institutions." },
]
    ...
    <>
      ...
      <SEOLandingPage
        ...
        introParagraphs={[
          ...
          "Delhi has a higher concentration of NAAC A+ colleges than most Indian cities, reflecting the city's commitment to educational excellence. These institutions span all major disciplines: DTU Delhi and IIIT Delhi for engineering, Symbiosis University for management, Miranda House College for arts and science, SNDT Women's University for women's education, and DY Patil University for medical sciences.",
