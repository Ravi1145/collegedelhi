...
export const metadata: Metadata = genMeta({
  ...
  keywords: [
    ...
    "NSP Delhi Scholarship scholarship 2026",
    "nsp scholarship Delhi 2026",
    "engineering scholarship Delhi 2026",
    "mba scholarship Delhi 2026",
    "ebc scholarship Delhi 2026",
    "obc scholarship Delhi 2026",
    "merit scholarship Delhi college",
    "government scholarship Delhi students",
    "scholarship for sc st students Delhi 2026",
    "minority scholarship Delhi 2026",
  ],
})
...
const scholarships = [
  // Government — State
  {
    name: "NSP Delhi Scholarship — Freeship / Tuition Fee Waiver",
  ...
  {
    name: "NSP Delhi Scholarship — OBC Scholarship",
  ...
  {
    name: "NSP Delhi Scholarship — SC/ST Post-Matric Scholarship",
  ...
  // College / Private
  {
    name: "DTU Delhi Merit Scholarship",
...
const faqs = [
  {
    question: "How do I apply for NSP Delhi Scholarship scholarship 2026?",
    answer: "Apply at NSP Delhi Scholarship.Delhi.gov.in. Steps: (1) Register with Aadhaar + mobile. (2) Choose your scheme (Freeship, OBC, SC/ST Post-Matric). (3) Upload documents: Caste certificate, income certificate, 12th marksheet, college admission letter, bank passbook (student's name). (4) Submit before September 30, 2026. Process at nearest Maha e-Seva centre if online help needed.",
  },
  {
    question: "Can engineering students get scholarship in Delhi?",
    answer: "Yes — multiple scholarships available for Delhi engineering students 2026: (1) NSP Delhi Scholarship Freeship — full fee waiver for EBC students (income < ₹8 LPA). (2) OBC Scholarship — ₹2,000–5,000/year for OBC/VJNT/NT students. (3) SC/ST Post-Matric — full fees + monthly maintenance. (4) NSP Central Sector Scheme — ₹10,000–20,000/year for merit students. (5) DTU Delhi Merit Scholarship — ₹25,000–50,000/year for top performers.",
  },
  {
    ...
    <>
      ...
      <div className="bg-surface min-h-screen">
        ...
        <div className="bg-gradient-to-r from-[#0A1628] to-[#0D3B2E] py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mb-5">
              10 verified scholarships — government & private — for engineering, MBA, medical, and arts students in Delhi. Updated deadlines and direct application links.
            </p>
            <div className="flex flex-wrap gap-3">
              {["NSP Delhi Scholarship Freeship", "NSP Central", "SC/ST Post-Matric", "OBC Scholarship", "Merit-based"].map((tag) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
          ...
          {/* Scholarship cards */}
          <div>
            <h2 className="text-2xl font-extrabold text-gray-900 mb-6">All Scholarships for Delhi Students 2026</h2>
                ...
                <div key={s.name} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md transition-shadow">
                  <div className="flex flex-wrap items-start gap-3 mb-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-red-700 font-semibold">{s.category}</p>
                    </div>
                    <a
                      href={s.link}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="shrink-0 text-xs font-bold bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-xl transition-colors"
                    >
                      Apply →
                    </a>
                  </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600">
              {[
                ...
                "NSP and NSP Delhi Scholarship are separate portals — apply to both independently.",
          ...
          {/* FAQ */}
          <div>
            <h2 className="text-xl font-extrabold text-gray-900 mb-5">FAQ — Scholarships for Delhi College Students</h2>
          ...
          <div className="bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] rounded-2xl p-6 text-center">
            ...
            <p className="text-gray-300 text-sm mb-4">Our counsellors help Delhi college students complete NSP Delhi Scholarship, NSP, and college scholarship applications — completely free.</p>
