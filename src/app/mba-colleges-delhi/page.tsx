          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {[
                ...
                { label: "MBA in Operations — Delhi Colleges", href: "/mba-in-operations-delhi", icon: "" },
                ...
                { label: "MBA Colleges in Gurgaon 2026", href: "/mba-colleges-gurgaon", icon: "" },
                { label: "MBA Colleges in Greater Noida", href: "/mba-colleges-greater-noida", icon: "" },
