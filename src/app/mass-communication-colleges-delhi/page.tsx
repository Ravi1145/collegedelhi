...
const colleges = [
  ...
  { rank: 5, name: "Amity School of Communication, Noida", university: "Amity (Deemed)", naac: "A+", fees: "₹1.5L–₹2.5L/yr", program: "BA Journalism, BCom Media", exam: "Amity JEE", highlight: "Strong alumni network | Digital media focus | Noida campus" },
  { rank: 6, name: "Gargi College — BMC", university: "Delhi University", naac: "A", fees: "₹12K–₹15K/yr", program: "BMC (3yr)", exam: "CUET 90+", highlight: "Women's college | South Campus | Affordable" },
]
...
const faqs = [
  ...
  { question: "What is the fee for mass communication in Delhi colleges?", answer: "Mass communication fees in Delhi vary widely: DU colleges (LSR, DCAC, Gargi) charge ₹12,000–₹18,000/yr — India's most affordable journalism education. IP University affiliated colleges charge ₹80K–₹1.5L/yr. Jamia Millia Islamia charges ₹30,000–₹60,000/yr. Amity (deemed) charges ₹1.5–2.5L/yr. Total 3-year BMC/BJMC from DU costs just ₹40,000–₹55,000." },
  { question: "Is CUET required for mass communication in Delhi colleges?", answer: "Yes — for Delhi University colleges (LSR, DCAC, Gargi), CUET UG 2026 is mandatory for BMC/BA Journalism admission. Jamia Millia Islamia requires CUET + its own entrance test for BJMC. IP University colleges require IPU CET (separate from CUET). Amity has its own entrance exam (Amity JEE) and does not use CUET." },
