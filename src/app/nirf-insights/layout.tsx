...
export const metadata: Metadata = genMeta({
  ...
  description: "Explore NIRF 2026 rankings for Delhi colleges. Compare DTU Delhi (Rank 49), FMS Delhi (Rank 13), AFMC (Rank 4), IIIT Delhi (Rank 101) and 25+ colleges by NIRF scores across Teaching, Research, Placements and Perception.",
  path: "/nirf-insights",
  keywords: [
