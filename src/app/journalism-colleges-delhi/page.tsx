...
export const metadata: Metadata = genMeta({
  title: "Best Journalism Colleges in Delhi 2026",
...
const colleges = [
  ...
  { rank: 6, name: "Amity School of Communication, Noida", type: "Deemed University", naac: "A+", fees: "₹1.5L–₹2L/yr", program: "BA Journalism & Mass Comm (3yr)", exam: "Amity JEE", highlight: "Near Delhi | Strong alumni | Digital & PR specialisation" },
]
