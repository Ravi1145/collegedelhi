...
export const metadata: Metadata = genMeta({
  ...
  keywords: [
    ...
    "college admission guidance Delhi",
    "Delhi college counsellor",
    "free admission counselling",
    "college shortlisting Delhi",
  ],
})
...
const stats = [
  ...
  { value: "25+", label: "Delhi Colleges Covered", icon: Award },
]
    ...
    <div className="bg-surface min-h-screen">
      ...
      <div className="bg-gradient-to-r from-[#0A1628] to-[#1E3A5F] py-14 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white mb-4 leading-tight">
            ...
            <span className="text-red-400">Delhi College Admissions 2026</span>
          </h1>
          <p className="text-blue-200 text-base max-w-2xl mx-auto mb-6">
            Talk to our Delhi education specialists. Get a personalized college shortlist, fee breakdown, and admission roadmap — in just 15 minutes.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {[
            ...
            },
            {
              ...
              desc: "Get a personalised list of the best-fit Delhi colleges with fees, NAAC grades, and placement data.",
            },
            {
              step: "3",
            ...
            <div key={step} className="bg-white rounded-xl border border-gray-100 shadow-sm p-5">
              <div className="w-8 h-8 bg-red-600 rounded-full flex items-center justify-center text-white font-bold text-sm mb-3">
                {step}
              </div>
      ...
      <div className="max-w-3xl mx-auto px-4 pb-16">
        ...
        <div className="mt-8 bg-[#0A1628] rounded-2xl p-6 text-white text-center">
          ...
          <a
            href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "917753831118"}?text=${encodeURIComponent("Hi! I need free counselling for Delhi college admissions.")}`}
            target="_blank"
